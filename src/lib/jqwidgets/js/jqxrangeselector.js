    ...
    $.extend($.jqx._jqxRangeSelector.prototype, {
        ...
        setRange: function (from, to) {
            ...
            if (currentRange.from != from || currentRange.to != to) {
                ...
                this._raiseEvent("0", { from: from, to: to });
            };
        },
                ...
                var mouseUp = function (event) {
                    try {
                        ...
                        if (hasChange) {
                            ...
                            that._raiseEvent("0", { from: value.from, to: value.to });
                        }
                    }
                    catch (error) {
                    }
        ...
        _getValue: function (changing) {
            ...
            range.from = this._roundNumber(from, "marker");
            range.to = this._roundNumber(from + sliderWidth * this._unitPerPixel, "marker");
