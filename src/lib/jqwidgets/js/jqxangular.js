        ...
        var linkFunction = function (scope, element, attrs, controllers, transclude) {
            ...
            var stop = $interval(function () {
                ...
                var createWidget = function () {
                    ...
                    var isInput = name.match(/(input|list|radio|checkbox|combobox|rating|slider|scrollbar|progress|range|editor|picker|range|gauge|calendar|switch|button)/ig);
                    ...
                    var raiseCreated = function () {
                        ...
                        if (attrs.jqxSettings && $parse(attrs.jqxSettings)(scope).created) {
                            $timeout(function () {
                    ...
                    $timeout(function update() {
                        if (ngModel) {
                            ...
                            else if (name === "jqxDropDownList" || name === "jqxComboBox" || name === "jqxListBox" || name === "jqxInput") {
