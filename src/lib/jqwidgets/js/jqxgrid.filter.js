                        ...
                        case 'input':
                            ...
                            if (this.host.jqxDropDownList) {
                                ...
                                if (selectedIndex == 0) {
                                    ...
                                    var newIndex = source.indexOf("contains");
                        ...
                        if (columnrecord._filterwidget.jqxDateTimeInput) {
                            if (columnrecord.filtertype == "range") {
                                ...
                                if (filtervalue != null) {
                                    ...
                                    var filter1 = filtergroup.createfilter(filtertype, date1, "EQUAL");
                                    filtergroup.addfilter(0, filter1);
                                }
                                else hasFilter = false;
                            }
            ...
            switch (columnrecord.filtertype) {
                ...
                case 'range':
                    if (this.host.jqxDateTimeInput) {
                        ...
                        datetimeinput.jqxDateTimeInput({ readonly: true, disabled: me.disabled, localization: localization, rtl: me.rtl, showFooter: true, formatString: columnrecord.cellsformat, selectionMode: columnrecord.filtertype, value: null, theme: this.theme, width: width - 10, height: this.filterrowheight - 10 });
                        if (columnrecord.createfilterwidget) {
            ...
            if (this._hasdatefilter && (column.filtertype !== "list" && column.filtertype !== "checkedlist" && column.filtertype !== "custom")) {
                ...
                if (column.filtertype == "date") {
                    ...
                    var initInput = function (input) {
                        ...
                        input.jqxDateTimeInput({ disabled: me.disabled, localization: localization, rtl: me.rtl, width: me._filterpanelwidth - 15, height: 20, value: null, formatString: column.cellsformat, theme: me.theme });
                    }
                    initInput(input);
                    ...
                    var input = $("<input class='filtertext1" + me.element.id + "' style='height: 20px; margin-top: 3px; margin-bottom: 3px;' type='text'></input>");
                    filter1.append(input);
                    var initInput = function (input) {
                        ...
                        input.width(me._filterpanelwidth - 15);
                    }
                    initInput(input);

                    var input = $("<input class='filtertext2" + me.element.id + "' style='height: 20px; margin-top: 3px; margin-bottom: 3px;' type='text'></input>");
                    filter2.append(input);
                    initInput(input);
                }
                var input1 = $element.find('.filtertext1' + me.element.id);
