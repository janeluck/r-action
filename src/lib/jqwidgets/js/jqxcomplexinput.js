...
(function ($) {
    ...
    $.extend($.jqx._jqxComplexInput.prototype, {
        ...
        createInstance: function () {
            ...
            that._currentNumber = new Object(); // stores the current number (on the change event) and its real and imaginary parts
        ...
        render: function () {
            ...
            if (that.decimalNotation === 'exponential' && that.value.toLowerCase().indexOf('e') !== -1) {
                ...
                that._currentNumber = { value: that.value, realPart: that.getReal(that.value), imaginaryPart: that.getImaginary(that.value) };
            }
