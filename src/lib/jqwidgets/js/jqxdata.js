...
(function ($) {
    ...
    !(function () { try { Object.defineProperty({}, 'x', {}); return true; } catch (e) { return false; } }())) {
        ...
        that.unshift = function () {
            ...
            if (typeof notifier === "function") {
                notifier({ object: that, type: 'add', index: index, name: "length", newValue: array.length, oldValue: index });
            }
            return array.length;
        };
...
longObj.mathObj.Long.fromBits(0xFFFFFFFF | 0, 0x7FFFFFFF | 0);
  ...
  other.lessThan(longObj.mathObj.Long.TWO_PWR_24_)) {
    ...
    $.jqx.math = function () {
        ...
        mathObj.getDecimalNotation = function (value, outputNotation) {
            ...
            function defaultToExponential(defaultValue) {
                if (defaultValue === '0') {
                    return parseInt(defaultValue).toExponential();
                }
            ...
            function exponentialToEngineering(exponentialValue) {
                ...
                var engineeringValue = coefficient + '×10' + toSuperScript((parseInt(power, 10) - remainderPower).toString());
