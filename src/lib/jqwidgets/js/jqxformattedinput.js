...
(function ($) {
    ...
    $.extend($.jqx._jqxFormattedInput.prototype, {
        ...
        val: function (value) {
            ...
            if (value && !(typeof value === 'object' && $.isEmptyObject(value) === true) && value !== 'binary' && value !== 'octal' && value !== 'decimal' && value !== 'exponential' && value !== 'scientific' && value !== 'engineering' && value !== 'hexadecimal') {
