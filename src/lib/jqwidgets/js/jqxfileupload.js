    ...
    $.extend($.jqx._jqxFileUpload.prototype, {
        ...
        _addFormAndFileInput: function () {
            ...
            that.addHandler(fileInput, 'change.jqxFileUpload' + id, function () {
                ...
                var fileObject = that._addFileRow(value, form, fileInput);
        ...
        // adds a file row
        _addFileRow: function (fileNameText, form, fileInput) {
            var that = this,
                fileRow,
                fileNameContainer,
                loadingElement,
            ...
            that._raiseEvent('0', { file: fileNameText }); // select event
