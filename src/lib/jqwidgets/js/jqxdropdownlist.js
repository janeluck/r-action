    ...
    $.extend($.jqx._jqxDropDownList.prototype, {
        ...
        render: function () {
            ...
            if (self.host.attr('tabindex')) {
                self.host.attr('tabindex', self.host.attr('tabindex'));
                self.host.removeAttr('tabindex');
            }
            else {
